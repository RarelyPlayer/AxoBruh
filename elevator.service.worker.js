...
/** @type {string} */
const CACHE_VERSION = '1760997319|825291371';
/** @type {string} */
const CACHE_PREFIX = 'AxoBruh-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'elevator.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["elevator.html","elevator.js","elevator.offline.html","elevator.icon.png","elevator.apple-touch-icon.png","elevator.audio.worklet.js","elevator.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["elevator.wasm","elevator.pck"];
